...
public class SeleniumUtils {
	...
	public static String genRandomStringByTableParam(String length) {
		return RandomStringUtils.randomAlphanumeric(Integer.parseInt(length.split(" ")[1]));
	}

	public static String genRandomNumberByTalbeParam(String length) {
		return RandomStringUtils.randomNumeric(Integer.parseInt(length.split(" ")[1]));
	}
